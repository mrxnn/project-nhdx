...
service / on new fhirr4:Listener(9090, apiConfig) {
    ...
    isolated resource function post fhir/r4/Encounter (r4:FHIRContext fhirContext, Encounter procedure) returns r4:Bundle|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }

    // Update the current state of a resource completely.
    isolated resource function put fhir/r4/Encounter/[string id] (r4:FHIRContext fhirContext, Encounter encounter) returns r4:Bundle|r4:FHIRError {
        return r4:createFHIRError("Not implemented", r4:ERROR, r4:INFORMATIONAL, httpStatusCode = http:STATUS_NOT_IMPLEMENTED);
    }
