...
| Profile URL          |[http://openhie.org/fhir/sri-lanka/StructureDefinition/drug-dispensation](http://openhie.org/fhir/sri-lanka/StructureDefinition/drug-dispensation)|
...
Pull the template from central
    ...
    ` bal new -t ballerinax/health.fhir.r4.lkcore010.medicationdispense MedicationDispenseAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type MedicationDispense r4:MedicationDispense|<Other_MedicationDispense_Profile>;`.
    ...
    - Eg: `profiles: ["http://openhie.org/fhir/sri-lanka/StructureDefinition/drug-dispensation", "new_profile_url"]`
