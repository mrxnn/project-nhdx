...
| Profile URL          |[http://openhie.org/fhir/sri-lanka/StructureDefinition/medication-request](http://openhie.org/fhir/sri-lanka/StructureDefinition/medication-request)|
...
Pull the template from central
    ...
    ` bal new -t ballerinax/health.fhir.r4.lkcore010.medicationrequest MedicationRequestAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type MedicationRequest r4:MedicationRequest|<Other_MedicationRequest_Profile>;`.
    ...
    - Eg: `profiles: ["http://openhie.org/fhir/sri-lanka/StructureDefinition/medication-request", "new_profile_url"]`
